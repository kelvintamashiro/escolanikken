<%-- 
    Document   : rel_telefone_pais
    Created on : 16/07/2020, 08:31:49
    Author     : macuser
--%>
...
<html lang="pt-br" class="js-disabled">
    ...
    <body>
        <table border="0" align="center" style="background-color: #F4F4F4" width="100%">
            ...
            <tr>
                <td align="center">
                    <h2>Lista de Telefones dos Pais</h2>
                </td>
            </tr>
        </table>
        <table class="table" style="font-size: 10px" id="exportable_table">
            <tr>
                <td>&nbsp;</td>
                <td><b>Série/Ano</b></td>
                <td><b>Aluno</b></td>
                ...
                <td><b>Telefone do Pai</b></td>
                <td><b>Contato de Emergência</b></td>
                <td><b>Telefone Emergência</b></td>
            </tr>
            <logic:present name="listaTelefonesPais" scope="request">
                <%int i = 1;%>
                <logic:iterate id="lista" name="listaTelefonesPais" scope="request">
        ...
        <script type="text/javascript">
            function ExportExcel(type, fn, dl) {
                ...
                return dl ?
                        ...
                        XLSX.writeFile(wb, fn || ('ListaTelefonePais.' + (type || 'xlsx')));
            }
        </script>
    </body>
</html>
