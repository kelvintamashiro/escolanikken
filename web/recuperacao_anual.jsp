                    ...
                    <tr>
                        <td width="25%">
                            <div class="col-lg-11">
                                ...
                                <html:select name="RecuperacaoAnualForm" property="idSerieAno" styleId="idSerieAno" styleClass="form-control form-control-sm">
                        ...
                        <td width="25%">
                            <div class="col-lg-10">
                                ...
                                <html:select name="RecuperacaoAnualForm" property="ano" styleId="ano" styleClass="form-control form-control-sm">
                    ...
                    <table border="0" class="table-condensed" align="center" style="margin-top: 20px;" width="90%">
                        ...
                        <logic:iterate name="listaAlunosDisciplinaRecupAnual" id="listaTotal" scope="request">
                            <tr>
                                ...
                                <td width="10%">
                                    <input class="btn btn-sm btn-dark" type="button" value="Incluir Nota" onClick="fIncluirNotaPage(<bean:write name="listaTotal" property="idAluno"/>, <bean:write name="listaTotal" property="idDisciplina"/>, '<bean:write name="listaTotal" property="mediaAnual"/>', '<bean:write name="listaTotal" property="nomeDisciplina"/>', '<bean:write name="listaTotal" property="nomeAluno"/>');">
                                </td>
                                <td width="10%">&nbsp;</td>
                            </tr>
                        </logic:iterate>
                            ...
                            <tr>
                                ...
                                <td width="10%">
                                    <logic:equal name="tipoPerfil" scope="session" value="coordenacao">
                                        <input class="btn btn-sm btn-danger" type="button" value="Excluir" onClick="fExcluir(<bean:write name="lista" property="id"/>);">
                                    </logic:equal>
