                    ...
                    <tr>
                        <td>
                            <div class="col-lg-12">
                                ...
                                <html:select name="RelatoriosForm" property="nrBimestre" styleId="nrBimestre" styleClass="form-control form-control-sm">
                    ...
                    <tr>
                        <td>
                            <div class="col-lg-12">
                                ...
                                <html:select name="RelatoriosForm" property="ano" styleId="ano" styleClass="form-control form-control-sm">
                    ...
                    <tr>
                        <td>
                            <div class="col-lg-12">
                                ...
                                <html:select name="RelatoriosForm" property="qtdMelhoresNotas" styleId="qtdMelhoresNotas" styleClass="form-control form-control-sm">
