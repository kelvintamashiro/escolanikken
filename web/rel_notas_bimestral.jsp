<%-- 
    Document   : rel_notas_bimestral
    Created on : 17/07/2020, 13:19:50
    Author     : macuser
--%>
                    ...
                    <tr>
                        ...
                        <logic:iterate id="notas" name="lista" property="listaNotas">
                            ...
                            <td align="center">
                                ...
                                <logic:equal name="notaBimestre" property="notaBimestral" value="">
                                    -
                                </logic:equal>
                                <logic:notEqual name="notaBimestre" property="notaBimestral" value="">
                                    <b><bean:write name="notaBimestre" property="notaBimestral"/></b>
                                </logic:notEqual>
                            </td>
                        </logic:iterate>
                    </tr>
        ...
        <script type="text/javascript">
            function ExportExcel(type, fn, dl) {
                ...
                return dl ?
                        ...
                        XLSX.writeFile(wb, fn || ('RelatorioNotasBimestrais.' + (type || 'xlsx')));
            }
        </script>
    </body>
</html>
