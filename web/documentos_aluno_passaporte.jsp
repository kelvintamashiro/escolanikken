<%-- 
    Document   : documentos_aluno_passaporte
    Created on : 28/10/2020, 20:32:05
    Author     : macuser
--%>
            ...
            <table border="0" align="center" style="margin-top: 20px; background-color: #ADD8E6" width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <h1>Rematricula de Aluno - Documentos Passaporte</h1>
                    </td>
                    <td width="10%">&nbsp;</td>
                </tr>
            </table>
            ...
            <table width="100%" style="background-color: #F5F5F5; height: 100px">
                <tr>
                    <td align="center">
                        ...
                        <input class="btn btn-info" type="button" value="4.Envio Passaporte" onClick="fEnvioDocPassaporte(<bean:write name="AlunoForm" property="idPF"/>);" style="border-bottom: 3px solid black; color: white">
