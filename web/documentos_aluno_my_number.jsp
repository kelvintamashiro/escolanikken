<%-- 
    Document   : documentos_aluno_my_number
    Created on : 28/10/2020, 20:22:57
    Author     : macuser
--%>
            ...
            <table border="0" align="center" style="margin-top: 20px; background-color: #ADD8E6" width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <h1>Rematricula de Aluno - Documentos MyNumber</h1>
                    </td>
                    <td width="10%">&nbsp;</td>
                </tr>
            </table>
            ...
            <table width="100%" style="background-color: #F5F5F5; height: 100px">
                <tr>
                    <td align="center">
                        ...
                        <input class="btn btn-info" type="button" value="3.Envio MyNumber" onClick="fEnvioDocMyNumber(<bean:write name="AlunoForm" property="idPF"/>);" style="border-bottom: 3px solid black; color: white">
                ...
                <table border="0" align="center" style="margin-top: 20px;" width="80%">
                    <tr>
                        <td align="center" style="color: red">
                            Nessa área envie em anexo os documentos solicitados
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <%--            <div class="form-group">
                            <table border="0" align="center" width="80%" style="background-color: #FFF0F5;">
                                ...
                                <tr>
                                    ...
                                    <td width="33%">
                                        <div class="col-lg-12">
                                            <label for="usr">Passaporte Mãe</label>
