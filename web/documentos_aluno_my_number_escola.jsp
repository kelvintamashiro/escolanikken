<%-- 
    Document   : documentos_aluno_my_number_escola
    Created on : 30/10/2020, 21:13:57
    Author     : macuser
--%>
            ...
            <table border="0" align="center" style="margin-top: 20px; background-color: #ADD8E6" width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <h1>Informações Aluno - Documentos MyNumber</h1>
                    </td>
                    <td width="10%">&nbsp;</td>
                </tr>
            </table>
                    ...
                    <table width="100%" style="background-color: #F5F5F5; height: 100px">
                        <tr>
                            <td align="center">
                                ...
                                <input class="btn btn-info" type="button" value="3.Doc MyNumber" onClick="fEnvioDocMyNumber(<bean:write name="AlunoForm" property="idPF"/>);" style="border-bottom: 3px solid black; color: white">
                    ...
                    <tr>
                        <td width="33%">
                            <div class="col-lg-12">
                                ...
                                <html:file name="RematriculaForm" property="myNumberAluno" styleClass="form-control" disabled="true"/>
                            </div>
                        </td>
                        <td width="33%">
                            <div class="col-lg-12">
                                <label for="usr">My Number Pai</label>
                                <html:file name="RematriculaForm" property="myNumberPai" styleClass="form-control" disabled="true"/>
                            </div>
                        </td>
                        <td width="33%">
                            <div class="col-lg-12">
                                <label for="usr">My Number Mãe</label>
                                <html:file name="RematriculaForm" property="myNumberMae" styleClass="form-control" disabled="true"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<script language="javascript">
    function fSalvar(idPF) {
        var uploadAluno = document.RematriculaForm.myNumberAluno;
        var uploadPai = document.RematriculaForm.myNumberPai;
        var uploadMae = document.RematriculaForm.myNumberMae;

        var sizeAluno = 0;
        var sizePai = 0;
        var sizeMae = 0;
        if (document.RematriculaForm.myNumberAluno.value != "") {
            sizeAluno = uploadAluno.files[0].size;
        }
        if (document.RematriculaForm.myNumberPai.value != "") {
            sizePai = uploadPai.files[0].size;
        }
        if (document.RematriculaForm.myNumberMae.value != "") {
        ...
        if (sizeAluno > sizeMb || sizePai > sizeMb || sizeMae > sizeMb) {
            ...
            document.RematriculaForm.action = "Rematricula.do?action=salvarDocMyNumber&idPF=" + idPF;
...
//            document.RematriculaForm.action = "Rematricula.do?action=excluirDocMyNumber&idDocumento=" + idDocumento + "&idPF=" + idPF + "&tipoDocumento=" + tipo;
//            document.RematriculaForm.submit();
//        }
//    }
