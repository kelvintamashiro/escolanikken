...
<html lang="pt-br" class="js-disabled">
    ...
    <body>
        <table border="0" align="center" style="background-color: #F4F4F4" width="100%">
            ...
            <tr>
                <td align="center">
                    <h2>Relatório de Lançamento de Notas (<bean:write name="RelatoriosForm" property="dataInicio"/> à <bean:write name="RelatoriosForm" property="dataFim"/>)</h2>
                </td>
            </tr>
        </table>
            ...
            <logic:present name="historicoLancamentoNotas" scope="request">
                ...
                <logic:iterate id="lista" name="historicoLancamentoNotas" scope="request">
                    ...
                    <tr>
                        ...
                        <td><bean:write name="lista" property="nrBimestre"/>º Bim.</td>
