<%-- 
    Document   : documentos_aluno_escolares
    Created on : 27/10/2020, 23:46:22
    Author     : macuser
--%>
        ...
        <html:form action="Rematricula.do?action=salvarDocumentosAluno" method="post" enctype="multipart/form-data">
            ...
            <table border="0" align="center" style="margin-top: 20px; background-color: #ADD8E6" width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <h1>Rematricula de Aluno - Documentos Escolares</h1>
                    </td>
                    <td width="10%">&nbsp;</td>
                </tr>
            </table>
            ...
            <table width="100%" style="background-color: #F5F5F5; height: 100px">
                <tr>
                    <td align="center">
                        ...
                        <input class="btn btn-info" type="button" value="5.Envio de Documentos Escolares" onClick="fEnvioDocumentosEscolares(<bean:write name="AlunoForm" property="idPF"/>);" style="border-bottom: 3px solid black; color: white">
                    </td>
                </tr>
            </table>
                ...
                <table border="0" align="center" width="80%" style="background-color: #F5F5DC;">
                    <tr>
                        <td colspan="2" align="center" style="padding: 30px">
                            <b>Envio dos Documentos: Dados Escolares</b>
                        </td>
                    </tr>
                    <tr>
                        <td width="50%">
                            <div class="col-lg-12">
                                ...
                                <html:file name="RematriculaForm" property="historicoEscolar" styleClass="form-control"/>
                            </div>
                        </td>
                        <td width="50%">
                            <div class="col-lg-12">
                                <label for="usr">Transferência Escolar</label>
                                <html:file name="RematriculaForm" property="transferenciaEscolar" styleClass="form-control"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="form-group">
                <table border="0" align="center" width="80%" style="background-color: #F0FFFF;">
                    <tr>
                        <td colspan="2" align="center" style="padding: 30px">
                            <b>Envio dos Documentos: Dados Pessoais</b>
                        </td>
                    </tr>
                    <tr>
                        <td width="50%">
                            <div class="col-lg-12">
                                ...
                                <html:file name="RematriculaForm" property="foto3x4" styleClass="form-control"/>
                            </div>
                        </td>
                        <td width="50%">
                            <div class="col-lg-12">
                                <label for="usr">Caderneta Bancária</label>
                                <html:file name="RematriculaForm" property="cadernetaBancaria" styleClass="form-control"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
