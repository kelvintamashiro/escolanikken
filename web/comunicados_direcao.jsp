<%-- 
    Document   : comunicados_direcao
    Created on : 06/08/2020, 14:32:10
    Author     : macuser
--%>
                        ...
                        <td valign="top">
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                        <input type="button" name="Button"  class="btn btn-sm btn-success" value="Comunicado Por Aluno" onClick="fComunicadoAluno();">
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<script language="JavaScript">
    function fSalvar() {
        if (document.ComunicadosForm.assunto.value === "") {
            ...
            document.ComunicadosForm.action = "Comunicados.do?action=salvarDirecao&tipoComunicado=DIRECAO";
