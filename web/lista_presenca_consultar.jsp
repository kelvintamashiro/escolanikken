                        ...
                        <logic:present name="listaDisciplinas" scope="session">
                            ...
                            <td width="10%">
                                <div class="col-lg-12">
                                    ...
                                    <input class="btn btn-sm btn-success" type="button" value="Consultar" onClick="fConsultar();">    
                                </div>
                            </td>
                        </logic:present>
                    ...
                    <table border="1" class="table-condensed" align="center"  width="80%">
                        ...
                        <logic:iterate name="listaAlunosPresenca" id="lista" scope="request">
                            ...
                            <tr <%=strCor%>>
                                ...
                                <td>
                                    <input class="btn btn-sm btn-primary" type="button" value="Editar" onClick="fEditar(<bean:write name="lista" property="idPresenca"/>);">    
                                </td>
                            </tr>
                        </logic:iterate>
                        <tr>
