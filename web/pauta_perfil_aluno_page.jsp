                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="col-lg-12">
                                                ...
                                                <html:text name="PautaForm" property="obsParticipacaoAula" styleId="obsParticipacaoAula" styleClass="form-control form-control-sm" maxlength="250"/>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="col-lg-12">
                                                ...
                                                <html:text name="PautaForm" property="obsRealizacaoTarefa" styleId="obsRealizacaoTarefa" styleClass="form-control form-control-sm" maxlength="250"/>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="col-lg-12">
                                                ...
                                                <html:text name="PautaForm" property="obsOutroAssunto" styleId="obsOutroAssunto" styleClass="form-control form-control-sm" maxlength="250"/>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <logic:present name="listaAlunosJaCadastrado" scope="session">
                                    ...
                                    <logic:iterate name="listaAlunosJaCadastrado" id="listaCadastrado" scope="session">
                                        <tr>
                                            ...
                                            <td style="padding: 2px"><input style="font-size: 10px" class="btn btn-sm btn-dark" type="button" value="Editar" onClick="fVisualizar(<bean:write name="listaCadastrado" property="idPautaObsAluno"/>)"></td>
                                            <td style="padding: 2px"><input style="font-size: 10px; color: white" class="btn btn-sm btn-danger" type="button" value="Excluir" onClick="fExcluir(<bean:write name="listaCadastrado" property="idPautaObsAluno"/>)"></td>
                                        </tr>
                                    </logic:iterate>
                                </logic:present>
                            </table>
