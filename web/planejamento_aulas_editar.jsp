                    ...
                    <tr>
                        <logic:equal name="tipoPerfil" scope="session" value="professor">
                            <td align="center" colspan="2">
                                <input class="btn btn-green" type="button" value="Atualizar Planejamento" onClick="fAtualizar();">
                            </td>
                        </logic:equal>
                        <logic:equal name="tipoPerfil" scope="session" value="coordenacao">
                            ...
                            <td align="center">
                                <input class="btn btn-info" type="button" value="Vistado Coordenação/Diretoria" style="color: white" onClick="fVistado();">
                            </td>
                        </logic:equal>
