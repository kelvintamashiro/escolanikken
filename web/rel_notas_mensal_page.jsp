<%-- 
    Document   : rel_notas_mensal_page
    Created on : 16/07/2020, 10:56:12
    Author     : macuser
--%>
            ...
            <table border="0" align="center" style="margin-top: 20px; background-color: #ADD8E6" width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <h2>Relatório Notas Mensal (por bimestre)</h2>
                    </td>
                    <td width="10%">&nbsp;</td>
                </tr>
            </table>
...
<script language="javascript">
    function fPesquisar() {
        ...
        if (idSerieAno.length < 1) {
            ...
            document.RelatoriosForm.action = "Relatorios.do?action=relNotasMensalPorBimestre";
