<%-- 
    Document   : rel_notas_media
    Created on : 17/07/2020, 13:29:09
    Author     : macuser
--%>
...
<html lang="pt-br" class="js-disabled">
    ...
    <body>
        <table border="0" align="center" style="background-color: #F4F4F4" width="100%">
            ...
            <tr>
                <td align="center">
                    <h2>Relatório Média Final - <bean:write name="nrBimestre" scope="request"/>º Bimestre - <bean:write name="ano" scope="request"/></h2>
                </td>
            </tr>
        </table>
                    ...
                    <tr>
                        ...
                        <logic:iterate id="notas" name="lista" property="listaNotas">
                            ...
                            <td align="center">
                                ...
                                <logic:equal name="notaBimestre" property="mediaBimestre" value="">
                                    -
                                </logic:equal>
                                <logic:notEqual name="notaBimestre" property="mediaBimestre" value="">
